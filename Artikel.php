...
<body >
	...
	<div class="page2" width='600px' id="layanan">
		...
		<form method='post'>
		<label style="font-size:20px;color:#fff;font-family : 'Cambria', sans-serif;">Email: </label>
		<input type='email' name='email' style='padding-left:10px;border:1px solid #fff;width:600px;height:30px;'/>
		<br/><br/>
		<label style="font-size:20px;color:#fff;font-family : 'Cambria', sans-serif;">Pesan: </label>
		<br/>
		<textarea name='text'>
		</textarea>
		<br/><br/>
		...
		<?php 
			if(isset($_POST['submit'])){
				...
				if(mail("ikbaltoriq@yahoo.co.id","Layanan",$data)){
					echo "Berhasil";
				}else{
					echo "gagal";
				}
